...
- **Implementation Appendix**: Remote Bridge/Cockpit/Approval Gate の実装粒度は
  `docs/spec/appendix_remote_bridge_from_cockpit.md` に固定する。
...
## 7. 補遺（AGI Cockpit転用）
Remote Bridge / Cockpit実体 / 承認ゲート接続 / 監査イベントの詳細仕様は、
`docs/spec/appendix_remote_bridge_from_cockpit.md` に固定する。
