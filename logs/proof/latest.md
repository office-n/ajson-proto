...
### staged diff (stat)
 ajson/cli/__init__.py               |  0
 ajson/cli/__main__.py               |  5 +++
 ajson/cli/approval.py               | 89 +++++++++++++++++++++++++++++++++++++
 ajson/hands/allowlist.py            | 85 +++++++++++++++++++++++++++++++++++
 ajson/hands/approval_sqlite.py      | 22 ++++++---
 docs/design/phase9.8.2_schema_v1.md | 48 ++++++++++++++++++++
 docs/ops/admin_manual.md            | 25 +++++++++++
 docs/ops/cli_user_guide.md          | 58 ++++++++++++++++++++++++
 logs/proof/latest.md                | 56 ++++++++++++++++++-----
 scripts/ants_preflight.sh           | 19 ++++++--
 tests/test_cli_approval.py          | 79 ++++++++++++++++++++++++++++++++
 tests/test_network_security.py      | 86 +++++++++++++++++++++++++++++++++++
 12 files changed, 551 insertions(+), 21 deletions(-)
